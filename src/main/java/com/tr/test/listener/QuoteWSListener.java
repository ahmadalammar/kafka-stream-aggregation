...
@Slf4j
@Component
public class QuoteWSListener extends TextWebSocketHandler {

    private final KafkaTemplate<String, Object> kafkaTemplate;
    private final ObjectMapper objectMapper;

    QuoteWSListener(KafkaTemplate<String, Object> kafkaTemplate, ObjectMapper objectMapper) {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        kafkaTemplate.send("quote-topic", quoteDTO.getData().getIsin(), quoteDTO);
    }
